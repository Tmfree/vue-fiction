...
import { getLunbo, getHotFiction, getFreeFiction, getNewFiction, getQingFiction, getSearch } from "@/request/api"
export default {
    state: {
        lunboList: [],
        hotFictionList: [],
